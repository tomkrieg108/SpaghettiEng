...
namespace Cyc
{
  ...
  public:
    ...
    protected:
      ...
      void Resolve(SpgMth::Real time_step);

      //Calculates the separating velocity at this contact.
      SpgMth::Real CalculateSeparatingVelocity() const;


    private:
      // Handles the impulse calculations for this collision.
      void ResolveVelocity(SpgMth::Real time_step);

      // Handles the interpenetration resolution for this contact.
      void ResolveInterpenetration(SpgMth::Real time_step);
  };
