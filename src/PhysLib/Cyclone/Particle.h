...
namespace Cyc
{
  ...
  struct Particle
  {
    public:
      ...
      SpgMth::Vec3 GetPosition() const noexcept {
        return m_position;
      }

      SpgMth::Vec3 GetVelocity() const noexcept {
        return m_velocity;
      }

      SpgMth::Vec3 GetAcceleration() const noexcept {
      ...
      void AddForce(SpgMth::Vec3& force) noexcept {
      ...
      void SetVelocity(SpgMth::Vec3 const& velocity) {
        m_velocity = velocity;
      }
    ...
    public: 
      ...
      SpgMth::Vec3 m_position{0,0,0};
      SpgMth::Vec3 m_velocity{0,0,0};
      SpgMth::Vec3 m_acceleration{0,0,0};
      SpgMth::Vec3 m_force_accumulator{0,0,0};
