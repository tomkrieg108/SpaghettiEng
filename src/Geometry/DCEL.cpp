...
namespace Geom
{
  ...
  namespace Monotone_V2
  {
     ...
     MonotoneSpawner5000::MonotoneSpawner5000() :
       m_T(EdgeComparator(m_cur_event_point))
     {
     }

    MonotoneSpawner5000::MonotoneSpawner5000(const std::vector<Point2d>& points) : 
      m_polygon(points),
      m_T(EdgeComparator(m_cur_event_point))
    {
      m_polygon.Validate();
     ...
     void MonotoneSpawner5000::Clear()
     {
         m_polygon.Clear();
         m_event_queue.clear();
    ...
    void MonotoneSpawner5000::Set(const std::vector<Point2d>& points)
    {
      Clear();
    ...
    VertexCategory MonotoneSpawner5000::GetVertexCategory(DCEL_vertex* vertex)
    {
    ...
    void MonotoneSpawner5000::InitialiseEventQueue()
    {
      uint32_t i = 0;
      ...
      //sort in reverse order so that highest priority event at the end
      std::sort(m_event_queue.rbegin(), m_event_queue.rend(), EventComparator());
    }

    void MonotoneSpawner5000::Step()
    {
    ...
    void MonotoneSpawner5000::MakeMonotone()
    {
    ...
    std::vector<Point2d> MonotoneSpawner5000::GetDiagonalEndPoints()
    {
    ...
    void MonotoneSpawner5000::HandleStartVertex(const Event& e)
    {
    ...
    void MonotoneSpawner5000::HandleEndVertex(const Event& e)
    {
    ...
    void MonotoneSpawner5000::HandleSplitVertex(const Event& e)
    {
    ...
    bool MonotoneSpawner5000::PolygonInteriorOnRight(DCEL_vertex* v)
    {
      DCEL_HalfEdge* e = GetDepartingEdge(v);
    ...
    void MonotoneSpawner5000::PrintDiagonals()
    {
      SPG_TRACE("Diagonals: ------------------- ");
